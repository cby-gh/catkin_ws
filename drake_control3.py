...
def drake_cmd_publisher(u_cmd,x_cmd):
   ...
   # xmsg=LinkState()
    ...
    while not rospy.is_shutdown():
        drake_cmd_pub.publish(u_cmd[times])
        drake_cmd_pub_echo.publish(u_cmd[times])
...
if __name__ == '__main__':
    ...
    drake_cmd_pub_echo = rospy.Publisher('/drake_cmd_pub_echo', Float64, queue_size=100)
